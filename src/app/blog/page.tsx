...
export const metadataContract = createRouteMetadataContract(
  "/blog/",
  "건마에반하다 블로그 | 출장 문의 시간·주소 준비표",
  "샵 방문이 어려운 날과 자택·숙소 주소로 출장마사지를 문의할 때 적어둘 시각, 장소, 코스와 결제 항목을 정리했습니다.",
  ["건마에반하다 준비 메모", "출장마사지 통화 항목", "집에서 받는 마사지", "숙소 방문 마사지"],
);
      ...
      <div className={"t4-fixed-frame"}>
        <header className={"t4-fixed-hero"}>
          <div className={"t4-fixed-heroCopy"}>
            <p className={"t4-fixed-eyebrow"}>GEONMAE BANHADA · USEFUL NOTES</p>
        ...
        <section className={"t4-fixed-section"} aria-labelledby="blog-list-title">
          <div className={"t4-fixed-sectionHeader"}>
            <div>
              <p className={"t4-fixed-sectionKicker"}>GEONMAE BLOG</p>
